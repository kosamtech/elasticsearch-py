...
async def regular_search(
    ...
    try:
        ...
        max_pages = calculate_max_pages(total_hits=total_hits, limit=limit)
                ...
                "must": [
                    {
                        "knn": {
                            ...
                            "field": "embedding",
                            "k": 1e4 # since we have 3333 documents we can return them all
                        }
                    }
                ]
            }
...
@app.get("/api/v1/get_docs_per_year/")
async def regular_search(
    search_query: str,
    tokenizer: str = "standard"
) -> dict:
